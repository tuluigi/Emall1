...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   //     NSString *provience=[self.dataSourceArray objectAtIndex:indexPath.row];
        EMShopProvienceCityController *citysViewController=[[EMShopProvienceCityController alloc] initWithProvienceID:[NSString stringWithFormat:@"%ld",(long)areaModel.areaID] provienceName:areaModel.areaName];
